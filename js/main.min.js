...
function CoinAni(t){this.type=t,this.x=0,this.y=0,this.cur=0,this.move()}CoinAni.prototype.draw=function(t){t.save(),t.translate(this.x,this.y),t.rotate(d2a(this.rotate)),1==this.type||2==this.type||3==this.type?t.drawImage(JSON.coinAni1,0,60*this.cur,60,60,-30,-30,60,60):4!=this.type&&5!=this.type&&6!=this.type&&7!=this.type||t.drawImage(JSON.coinAni2,0,60*this.cur,60,60,-30,-30,60,60),t.restore()},CoinAni.prototype.move=function(){var t=this;setInterval(function(){t.x+=(0-t.x)/10,t.y+=(650-t.y)/10,t.cur++,10==t.cur&&(t.cur=0)},30)};CoinAni.prototype.playSong=function(){var oA=new Audio();oA.src = 'snd/coin.wav';oA.volume=1;oA.play();};
